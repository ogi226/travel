...
<body>
  <main>
    ...
    if (isset($_SESSION['customer'])) {
      ...
      $sql = $pdo->prepare('UPDATE plan SET deleted_at=? WHERE id=?and customer_id=?');
      $sql->execute([
        $current_time,
        $plan_id,
        $id
      ...
      echo '<h1 class="textalign_center">しおりを削除しました</h1>';
